 ...
 * @author THUAN
 */
public class ManagerUpdateOrdersController extends HttpServlet {

    private final String MANGER_PAGE = "ManagerUpdateOrders.jsp";
    private final String MANGER_P = "ManagerOrderController";
