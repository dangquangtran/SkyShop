                            ...
                            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                                <div class="col mb-5">
                                    <div class="card h-100">
                                        ...
                                        <!-- Product image-->
                                        <c:set var="listpic" value="${sessionScope.LIST_PICTURE}"/>
                                        <c:forEach items="${listpic}" var="pro1" >
                                            <c:if test="${pro.PicID = pro1.PicID}">
                                                <img class="card-img-top" src="${pro1.imgUrl}" alt="..." />
                                            </c:if>
                                        </c:forEach>
                                        <!-- Product details-->
                                        <div class="card-body p-4">
                                            <div class="text-center">
                                                ...
                                                <!-- Product price-->
                                                <span class="text-muted text-decoration-line-through">${pro.price} ${pro.discount}</span>
                                            </div>
                                        </div>
                                        <!-- Product actions-->
