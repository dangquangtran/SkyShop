                                    ...
                                    <div class="table-wrapper">
                                        ...
                                        <table class="table table-striped table-hover">
                                            <tr>
                                                ...
                                                <td>
                                                    ${user.subcategoryID}
                                                    <input  hidden name="ID" value="${user.subcategoryID}"  />
                                                </td>
                                                    </tr>
                                                        <tr>
                                                <td>SubCategory Name</td>
                                                <td>
                                                    <input  name="SubName" value="${user.subName}"  />
                                                </td>
                                                    </tr>
                                                     <tr>
                                                <td>Description</td>
                                            ...
                                            <tr>
                                                <td>
                                                     <button type="submit" name="btAction" value="Manage SubCategory">BACK</button>
                                                </td>
                                                <td>
                                                    <button type="submit" name="btAction" value="Manage_Update_SubCate">UPDATE</button>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
