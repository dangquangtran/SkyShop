                    ...
                    <div class="container-fluid">
                        ...
                        <div class="container-fluid">
                            <div class="d-flex align-items-center justify-content-between mb-3 mt-2">
                                <h5 class="mb-0">Danh sách cuốn sách </h5>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <c:forEach var="book" items="${listBook}">
                                <div class="col-xl-4 col-lg-4 col-md-4">
                                    <a href="/BookDetailController?id=${book.bookId}" class="text-dark text-decoration-none">
                                        <div class="bg-white shadow-sm rounded d-flex align-items-center p-1 mb-2 osahan-list">
                                            ...
                                            <div class="mx-3 py-2 w-100">
                                                <p class="mb-2 text-black">${book.bookName}</p>
                                                <p class="small mb-2">
