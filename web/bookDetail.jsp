                    ...
                    <section class="py-5">
                        <div class="container px-4 px-lg-5 my-5">
                            <div class="row gx-4 gx-lg-5 align-items-center">
                                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://nhasachphuongnam.com/images/detailed/265/nhung-nhac-khuc-hay-va-de-soan-cho-dan-piano-tb-2023-mockup.jpg" alt="..." /></div>
                                <div class="col-md-6">
                                    <h2 class="display-6 fw-bolder" style="color: steelblue">${book.bookName}</h2>
                                    <div class="fs-5 mb-5">
                                        <p class="card-text text-danger font-weight-bold" >${book.unitPrice}đ</p>
                                        <p class="lead">
                                            Tác giả:${book.authorName}
                                        </p>
                                        <p class="lead">
                                            Nhà xuất bản:${book.publishingCompany}
                                        </p>
                                        <p class="lead">
                                            Ngày xuất bản:${book.publishDate}
                                        </p>
                                    </div>
                                    <!-- 
                                    Add san pham
